...
func TestLoggerAddCallerFunction(t *testing.T) {
	tests := []struct {
		...
		},
		{
			...
			loggerFunction:  "github.com/zhangdapeng520/zdpgo_log/libs/zap.infoLog",
			sugaredFunction: "github.com/zhangdapeng520/zdpgo_log/libs/zap.infoLogSugared",
		},
		{
		...
		},
		{
			...
			loggerFunction:  "github.com/zhangdapeng520/zdpgo_log/libs/zap.withLogger",
			sugaredFunction: "github.com/zhangdapeng520/zdpgo_log/libs/zap.withLogger",
		},
		{
