...
func TestStacktraceFiltersVendorZap(t *testing.T) {
	...
	withGoPath(t, func(goPath string) {
		...
		testDir := filepath.Join(goPath, "src/github.com/zhangdapeng520/zdpgo_log/libs/zap/")
		...
		setupSymlink(t, zapDir, filepath.Join(vendorDir, "github.com/zhangdapeng520/zdpgo_log/libs/zap"))
